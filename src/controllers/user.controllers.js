...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    return res.status(200)
        .json(new ApiResponce(200, {}, "Password Changed sussfully"))
...
const getCurrentUser = asyncHandler(async (req, res) => {
    return res
        .status(200)
        .json(ApiResponce(200, res.user, "Current User Fetched successfully"))
})
...
const updateAcountDetails = asyncHandler(async (req, res) => {
    ...
    if (!fullName || email) {
        throw new ApiError(400, "all filds are requird")
    }
    ...
    return res
        .status(200)
        .json(new ApiResponce(200, user, "acount details updated successfully"))
})
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    if (!avatar) {
        throw ApiError(400, "Error while uploding on avatar")
    }
    ...
    return res
        .status(200)
        .json(ApiResponce(200, user, "avatar is updated successfully"))
})
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(ApiResponce(200, user, "coverImage is updated successfully"))
})
...
export { registerUser, logOutUser, loginUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAcountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory }  